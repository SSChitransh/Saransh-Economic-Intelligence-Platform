...
<p style="font-size: 1.4rem; font-weight: 600; color: #e8edf3; margin-top: 0;">
  Interactive Dashboard · 7 Indicators · 9 Countries · 23 Years
</p>

<p style="font-size: 1.1rem; max-width: 700px; margin: 0 auto; color: #b0b8c8;">
  Analyzing macroeconomic trends across <strong style="color: #f5c518;">G7 + India &amp; China</strong> with original research on <strong style="color: #f5c518;">education spending and poverty reduction</strong>.
</p>
...
<div style="background: #1a212b; border-left: 6px solid #f5c518; border-radius: 12px; padding: 20px 30px; max-width: 850px; margin: 0 auto; text-align: left; border: 1px solid #1e2733;">
  <p style="font-size: 1.1rem; color: #e8edf3; margin: 0;">
    <strong style="color: #f5c518;">🇮🇳 India</strong> shows the strongest negative correlation between education spending and poverty reduction 
    (<strong style="color: #f5c518;">r = -0.461</strong>, p < 0.001).
  </p>
  <p style="color: #8892a0; margin: 4px 0 0 0; font-size: 0.95rem;">
    → Every 1% increase in education spending reduces poverty by 1.75%.
  </p>
  <p style="color: #b0b8c8; margin: 8px 0 0 0; font-size: 0.9rem;">
    💡 <strong>Conclusion:</strong> Education investment is a powerful tool for poverty alleviation in <strong style="color: #f5c518;">developing economies</strong>.
  </p>
</div>
...
<p align="center" style="color: #5a6474;">
  Built with ❤️ by <strong style="color: #e8edf3;">Saransh</strong> &bull; MIT Maker Portfolio 2026
</p>

<p align="center" style="font-size: 0.85rem; color: #3a4455;">
  Data generated mathematically to mimic World Bank &amp; IMF trends.
</p>

<p align="center">
  <a href="https://github.com/SSChitransh/Saransh-Economic-Intelligence-Platform" style="color: #f5c518; font-weight: 600;">🐙 GitHub</a>
  &nbsp;·&nbsp;
  <a href="https://sschitransh.github.io/Saransh-Economic-Intelligence-Platform/" style="color: #f5c518; font-weight: 600;">📊 Live Dashboard</a>
  &nbsp;·&nbsp;
  <a href="#downloads" style="color: #f5c518; font-weight: 600;">📂 Downloads</a>
</p>
